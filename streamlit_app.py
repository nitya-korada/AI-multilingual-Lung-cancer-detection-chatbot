...
# Create and load Swin Transformer model
from torchvision.models import swin_t
swin_model = swin_t(weights=None)
swin_model.head = nn.Linear(swin_model.head.in_features, 1)
swin_model.load_state_dict(torch.load(swin_path, map_location=torch.device('cpu')))
swin_model.eval()

# Create and load ViT classifier model
