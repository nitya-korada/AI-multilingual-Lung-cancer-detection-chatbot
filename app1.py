...
Original file is located at
    https://colab.research.google.com/drive/1Up9BDIs_EKr3bWBpkmVerHS3K2D6RETT
"""
...
def load_model():
    ...
    repo_id="https://huggingface.co/Nitya9540/swin-lung-cancer-model",  # ← your HF model repo name
    filename="swin_lung_cancer.pth"
    )
...
def load_vit_classifier():
    ...
    model_path = hf_hub_download(
    repo_id="https://huggingface.co/Nitya9540/swin-lung-cancer-model",  # ← your HF model repo name
    filename="vit_lung_classifier.pth"
    )
